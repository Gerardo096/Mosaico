...
function crearTabla() {
    ...
    tabla.setAttribute("id", "plantilla");
...
function borrar() {
    tabla = document.getElementById("plantilla");
    borrarTd = tabla.getElementsByTagName("td");
    for (let c = 0; c < borrarTd.length; c++) {

        borrarTd[c].className = "color6";
